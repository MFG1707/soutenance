          ...
          <div class="card-body">
            ...
            <p class="card-description">
              ...
              if ($_SERVER["REQUEST_METHOD"] == "POST") {
                  ...
                  // Préparer la requête d'insertion de produit
                  $sql = "INSERT INTO produits (nom, description, quantite, prix, image)
                          VALUES ('$nom', '$description', $quantite, $prix, '$image')";

                  // Exécuter la requête d'insertion de produit
              ...
              <body>
                  ...
                  <form class="forms-sample" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" id="exampleInputDescription" rows="4" name="description"></textarea>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputQuantite">Quantité :</label>
                        <input type="number" class="form-control" id="exampleInputQuantite" placeholder="Quantité" name="quantite" required>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPrix">Prix :</label>
                        <input type="number" class="form-control" id="exampleInputPrix" placeholder="Prix" name="prix" step="100" required>
                      </div>
                      <div class="form-group">
                        <label>Image :</label>
