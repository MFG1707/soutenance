  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title">AFFICHER VOTRE STOCK RESTANT</h4>
            ...
            <?php
                ...
                if($_SERVER['REQUEST_METHOD'] == 'POST') {
                    ...
                    if(empty($id)) {
                        echo "Veuillez entrer un ID de produit.";
                    } else {
                        // Récupérer la quantité de produit restante dans la base de données
                        $sql = "SELECT quantite FROM produits WHERE id = $id";
                        $result = mysqli_query($conn, $sql);

                        if(mysqli_num_rows($result) > 0) {
                            $row = mysqli_fetch_assoc($result);
                            echo "Quantité restante pour le produit $id : " . $row['quantite'];
                        } else {
                ...
                <!-- Formulaire pour voir la quantité de produit restante -->
                <form class="forms-sample" method="POST" action="">
                  <div class="form-group">
                      <label for="exampleInputName1">ID du produit :</label>
                      <input type="text" class="form-control" id="exampleInputName1" name="id" required>
                  </div>
                  <button type="submit" class="btn btn-primary me-2">Voir quantité</button>
