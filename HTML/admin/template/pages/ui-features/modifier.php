  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title">MODIFIER LE STOCK</h4>
            ...
            <?php
              ...
              if($_SERVER['REQUEST_METHOD'] == 'POST') {
                  // Récupérer l'ID et la quantité du produit à modifier
                  $id = $_POST['id'];
                  $quantite = $_POST['quantite'];

                  // Vérifier si l'ID et la quantité sont valides
                  if(empty($id) || empty($quantite)) {
                      ...
                      if(mysqli_query($conn, $sql)) {
                          echo "Quantité ajoutée avec succès.";
                      } else {
              ...
              <!-- Formulaire pour ajouter des quantités de produit -->
              <form class="forms-sample" method="POST" action="">
                  <div class="form-group">
                      <label for="exampleInputName1">ID du produit :</label>
                      <input type="text" class="form-control" id="exampleInputName1" placeholder="ID du produit" name="id" required>
                  </div>
                  <div class="form-group">
                      <label for="exampleInputEmail3">Quantité à ajouter :</label>
                      <input type="text" class="form-control" id="exampleInputEmail3" placeholder="Quantité à ajouter" name="quantite" required>
                  </div>
