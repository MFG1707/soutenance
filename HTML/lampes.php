			...
			<div class="container">
				...
				<div class="col-md-9 col-sm-9 col-xs-12 content-area">
						...
						<?php
								...
								// Récupérer les données des produits à afficher (id_produit de 36 à 39)
								$sql = "SELECT * FROM produits WHERE id BETWEEN 36 AND 39";
								$result = mysqli_query($conn, $sql);
								...
								if (mysqli_num_rows($result) > 0) {
									while ($row = mysqli_fetch_assoc($result)) {
										...
										echo '<a title="Add To Cart" href="add_to_cart.php?user_id=<?php echo $_GET['id']; ?>" class="button product_type_simple add_to_cart_button" onclick="addToCart(' . $id_produit . ')"><i class="fa fa-shopping-cart" aria-hidden="true"></i>Add to cart</a>';
										echo '<span>';
