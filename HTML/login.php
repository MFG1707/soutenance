...
<head>
	...
	<title>Afrik Art - CONNEXION </title>
		...
		<div class="contact-us container-fluid no-padding">
			...
			<div class="container">
				<div class="col-md-6 col-sm-6 col-xs-6 contact-form">
					...
					<button type="submit" name="send2" class="button button-block" >Se connecter</button>
					
					<p class="message">Pas de compte ? <a href="register.php">Créez un compte</a></p>
					</form>
