					...
					<div class="dropdown-bar">
						...
						<div class="language-dropdown dropdown">
							...
							<ul class="dropdown-menu no-padding">
								<li><a href="login.php?user_id=<?php echo $id; ?>" title="Authentification">Connexion</a></li>
								<li><a href="register.php?user_id=<?php echo $id; ?>" title="Authentification">Inscription</a></li>
								<li><a href="logout.php?user_id=<?php echo $id; ?>" title="Deconnexion">Deconnexion</a></li>
							</ul>
						</div>
					</div>
				</div><!-- Container /- -->
					...
					<div class="row">
						<div class="col-md-5 col-sm-4 col-xs-4">
							<div class="logo-block">
								<a href="index.php?user_id=<?php echo $id; ?>"><img src="images/logo.png" alt="logo" height="150" width="220"/><span></span></a>
							</div>
						</div>
							...
							if (isset($_SESSION['user_id'])) {
								...
								if (mysqli_num_rows($result) > 0) {
									while ($row = mysqli_fetch_assoc($result)) {
										...
										$html .= '<a href="product-detail.php" class="shop-thumbnail">';
			...
			<div class="container">
				...
				<div class="col-md-3 col-sm-3 col-xs-12 widget-area">
					...
					<aside class="widget widget-categories">
						...
						<ul>
							<li><a href="tableaux.php" title="Living Room">Tableaux<span class="pull-right"></span></a></li>
							<li><a href="sculptures.php" title="Dining Room">Sculptures<span class="pull-right"></span></a></li>
							<li><a href="vases.php" title="Bed Room">Vases<span class="pull-right"></span></a></li>
							<li><a href="lampes.php" title="Sofas & Chairs">Lampes<span class="pull-right"></span></a></li>
							<li><a href="ustensiles.php" title="Sofas & Chairs">Ustensiles<span class="pull-right"></span></a></li>
							<li><a href="tables.php" title="Sofas & Chairs">Tables<span class="pull-right"></span></a></li>
							<li><a href="autres.php" title="Sofas & Chairs">Autres<span class="pull-right"></span></a></li>
						</ul>
				...
				<div class="col-md-9 col-sm-9 col-xs-12 content-area">
						...
						if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['product_id'])) {
							...
							// Ajouter les choix au panier avec l'ID de l'utilisateur
						...
						// Récupérer les données des produits à afficher (id_produit de 1 à 12)
						$sql = "SELECT * FROM produits WHERE id BETWEEN 1 AND 12";
						$result = mysqli_query($conn, $sql);
						...
						if (mysqli_num_rows($result) > 0) {
							while ($row = mysqli_fetch_assoc($result)) {
								...
								echo '<a href="product-detail.php?id=' . $id_produit . '&user_id=' . $_SESSION['user_id'] . '" title="Product">';
								...
								echo '<a title="Add To Cart" href="add_to_cart.php" class="button product_type_simple add_to_cart_button" onclick="addToCart(' . $id_produit . ', ' . $_SESSION['user_id'] . ')"><i class="fa fa-shopping-cart" aria-hidden="true"></i>Add to cart</a>';
								echo '<span>';
								echo '<a href="product-detail.php?id=' . $id_produit . '&user_id=' . $_SESSION['user_id'] . '" class="icons"><i class="fa fa-eye" aria-hidden="true"></i></a>';
								echo '</span>';
								echo '</p>';
								echo '</li>';
							}
						...
						<nav class="ow-pagination">
							<ul class="pagination">
								<li><a href="shop.php?user_id=<?php echo $id; ?>">1</a></li>
								<li><a href="shop2.php?user_id=<?php echo $id; ?>">2</a></li>
								<li><a href="shop3.php?user_id=<?php echo $id; ?>">3</a></li>
								<li><a href="shop4.php?user_id=<?php echo $id; ?>">4</a></li>
								<li><a href="shop5.php?user_id=<?php echo $id; ?>">5</a></li>
								<li><a href="shop6.php?user_id=<?php echo $id; ?>">6</a></li>
							</ul>
						</nav>
					</div><!-- Content Area /- -->
					</div><!-- Container /- -->
