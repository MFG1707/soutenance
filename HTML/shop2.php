			...
			<div class="container">
				...
				<div class="col-md-3 col-sm-3 col-xs-12 widget-area">
					...
					<aside class="widget widget-categories">
						...
						<ul>
							<li><a href="tableaux.php?user_id=<?php echo $_GET['id']; ?>" title="Living Room">Tableaux<span class="pull-right"></span></a></li>
							<li><a href="sculptures.php?user_id=<?php echo $_GET['id']; ?>" title="Dining Room">Sculptures<span class="pull-right"></span></a></li>
							<li><a href="vases.php?user_id=<?php echo $_GET['id']; ?>" title="Bed Room">Vases<span class="pull-right"></span></a></li>
							<li><a href="lampes.php?user_id=<?php echo $_GET['id']; ?>" title="Sofas & Chairs">Lampes<span class="pull-right"></span></a></li>
							<li><a href="ustensiles.php?user_id=<?php echo $_GET['id']; ?>" title="Sofas & Chairs">Ustensiles<span class="pull-right"></span></a></li>
							<li><a href="tables.php?user_id=<?php echo $_GET['id']; ?>" title="Sofas & Chairs">Tables<span class="pull-right"></span></a></li>
							<li><a href="autres.php?user_id=<?php echo $_GET['id']; ?>" title="Sofas & Chairs">Autres<span class="pull-right"></span></a></li>
						</ul>
				...
				<div class="col-md-9 col-sm-9 col-xs-12 content-area">
						...
						// Récupérer les données des produits à afficher (id_produit de 13 à 24)
						$sql = "SELECT * FROM produits WHERE id BETWEEN 13 AND 24";
						$result = mysqli_query($conn, $sql);
						...
						<nav class="ow-pagination">
							<ul class="pagination">
								<li><a href="shop.php?user_id=<?php echo $_GET['id']; ?>">1</a></li>
								<li><a href="shop2.php?user_id=<?php echo $_GET['id']; ?>">2</a></li>
								<li><a href="shop3.php?user_id=<?php echo $_GET['id']; ?>">3</a></li>
								<li><a href="shop4.php?user_id=<?php echo $_GET['id']; ?>">4</a></li>
								<li><a href="shop5.php?user_id=<?php echo $_GET['id']; ?>">5</a></li>
								<li><a href="shop6.php?user_id=<?php echo $_GET['id']; ?>">6</a></li>
							</ul>
						</nav>
					</div><!-- Content Area /- -->
					</div><!-- Container /- -->
