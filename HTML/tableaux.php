						...
						<?php
							...
							if (mysqli_num_rows($result) > 0) {
								while ($row = mysqli_fetch_assoc($result)) {
									...
									echo '<a title="Add To Cart" href="#" class="button product_type_simple add_to_cart_button"><i class="fa fa-shopping-cart" aria-hidden="true"></i>Add to cart</a>';
									echo '<span>';
									echo '<a href="#" class="icons"><i class="fa fa-heart" aria-hidden="true"></i></a>';
									echo '<a href="product-detail.php?id=' . $id_produit . '" class="icons"><i class="fa fa-eye" aria-hidden="true"></i></a>';
									echo '<a href="#" class="icons"><i class="fa fa-retweet" aria-hidden="true"></i></a>';
									echo '</span>';
									echo '</p>';
									echo '</li>';
								}
